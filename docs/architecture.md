...
> 最后更新：2026-09-14 | v3.3.13（⚠️ 架构正文基于 v3.1.4，最新工具清单/数据源数以仓库根 README.md v3.3.13 为准）
...
- **包名**：tradex（v3.3.13），astock_signals 已并入本仓 tradex/src/astock_signals 作为唯一主源（v3.3.11，独立仓已退役）
